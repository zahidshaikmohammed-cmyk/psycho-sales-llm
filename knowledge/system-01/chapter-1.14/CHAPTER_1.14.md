# CHAPTER 1.14 — PERSONALITY, SELF, IDENTITY, AND INDIVIDUAL DIFFERENCES

**Status:** RE-AUDITED & RESEALED — CANONICAL KNOWLEDGE VERSION 2.0
...
Personality provides the canonical psychological account of organized patterns of thought, feeling, motivation, and behavior. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
...
Personality trait provides the canonical psychological account of relatively enduring dimension of individual variation. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality trait has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Trait theory provides the canonical psychological account of approaches explaining personality through enduring dimensions. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Trait theory has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality state provides the canonical psychological account of time-limited configuration of personality-relevant states. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality state has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality process provides the canonical psychological account of dynamic mechanisms linking person characteristics and situations. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality process has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Trait activation provides the canonical psychological account of situational activation of trait-relevant tendencies. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Trait activation has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality stability provides the canonical psychological account of continuity of personality characteristics across time. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality stability has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality change provides the canonical psychological account of systematic change in personality characteristics. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality change has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality development provides the canonical psychological account of lifespan emergence, organization, stability, and change of personality. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality development has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Person–situation debate provides the canonical psychological account of how person characteristics and situations jointly relate to behavior. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Person–situation debate has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Interactionist personality model provides the canonical psychological account of behavior as a product of person–situation interaction. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Interactionist personality model has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Psychodynamic perspective provides the canonical psychological account of unconscious processes, conflict, development, relationships, and motivation. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Psychodynamic perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Behavioral perspective provides the canonical psychological account of learned behavior and environmental contingencies. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Behavioral perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Social-cognitive perspective provides the canonical psychological account of reciprocal relations among person factors, cognition, behavior, and social environment. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Social-cognitive perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Humanistic perspective provides the canonical psychological account of subjective experience, agency, meaning, and growth. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Humanistic perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Biological perspective provides the canonical psychological account of genetic, neural, physiological, and temperamental contributions. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Biological perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Evolutionary perspective provides the canonical psychological account of possible evolved functions and recurrent adaptive problems. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Evolutionary perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Trait perspective provides the canonical psychological account of measurable dimensions of relatively consistent individual differences. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Trait perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Cultural perspective provides the canonical psychological account of cultural systems, norms, practices, and meanings shaping personality. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Cultural perspective has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Big Five model provides the canonical psychological account of hierarchical organization of broad personality variation into five dimensions. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Big Five model has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Openness provides the canonical psychological account of curiosity, imagination, novelty, and receptivity to experience. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Openness has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Conscientiousness provides the canonical psychological account of organization, persistence, responsibility, and goal-directed regulation. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Conscientiousness has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Extraversion provides the canonical psychological account of sociability, assertiveness, activity, and positive engagement. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Extraversion has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Agreeableness provides the canonical psychological account of cooperation, warmth, trust, and concern for others. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Agreeableness has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Neuroticism provides the canonical psychological account of negative emotionality and sensitivity to distress or threat. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Neuroticism has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Temperament provides the canonical psychological account of early-emerging patterns of emotional reactivity and regulation. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Temperament has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Character provides the canonical psychological account of moral, motivational, or valued patterns of functioning. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Character has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Agency provides the canonical psychological account of capacity and tendency to initiate and regulate goal-directed action. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Agency has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Communion provides the canonical psychological account of orientation toward connection, belonging, cooperation, and relationships. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Communion has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self provides the canonical psychological account of organized psychological representation and experience of being a particular individual. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-concept provides the canonical psychological account of beliefs and representations about who one is. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-concept has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-schema provides the canonical psychological account of self-related knowledge structures influencing attention and interpretation. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-schema has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-awareness provides the canonical psychological account of awareness of one's own states, characteristics, actions, or self-related processes. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-awareness has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-knowledge provides the canonical psychological account of knowledge about one's own characteristics, patterns, motives, preferences, and history. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-knowledge has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-esteem provides the canonical psychological account of evaluation of one's own worth or value. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-esteem has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-worth provides the canonical psychological account of broader sense of having value as a person. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-worth has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-consistency provides the canonical psychological account of coherence or continuity among self-relevant beliefs and experiences. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-consistency has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-discrepancy provides the canonical psychological account of perceived mismatch among different self-representations. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-discrepancy has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Actual self provides the canonical psychological account of representation of characteristics believed to be currently possessed. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Actual self has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Ideal self provides the canonical psychological account of representation of characteristics one would ideally like to possess. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Ideal self has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Ought self provides the canonical psychological account of representation of characteristics one believes one should possess. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Ought self has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Possible selves provides the canonical psychological account of representations of what one might, could, or fears becoming. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Possible selves has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-verification provides the canonical psychological account of seeking or interpreting feedback that confirms important self-views. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-verification has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-enhancement provides the canonical psychological account of processes maintaining or increasing favorable self-views. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-enhancement has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-handicapping provides the canonical psychological account of creating or claiming obstacles that protect self-evaluation from failure. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-handicapping has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-presentation provides the canonical psychological account of behavior aimed at influencing how others perceive the self. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-presentation has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Impression management provides the canonical psychological account of strategic regulation of information or behavior to shape impressions. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Impression management has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-monitoring provides the canonical psychological account of monitoring social cues and adjusting behavior to situational demands. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-monitoring has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personal identity provides the canonical psychological account of sense of being a continuous and distinctive individual across time. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personal identity has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Identity structure provides the canonical psychological account of organization and accessibility of identities composing self-definition. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Identity structure has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Moral identity provides the canonical psychological account of centrality of moral qualities to self-definition. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Moral identity has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personal values provides the canonical psychological account of enduring beliefs about what is important, desirable, or worth pursuing. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personal values has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Locus of control provides the canonical psychological account of beliefs about whether outcomes depend mainly on one's actions or external forces. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Locus of control has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Attributional style provides the canonical psychological account of characteristic ways of explaining causes of events. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Attributional style has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Optimism provides the canonical psychological account of generalized expectation of favorable future outcomes. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Optimism has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Pessimism provides the canonical psychological account of generalized expectation of unfavorable future outcomes. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Pessimism has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Perfectionism provides the canonical psychological account of demanding standards and concerns about performance, evaluation, or mistakes. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Perfectionism has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Attachment style → 1.15 canonical owner (redirect only) provides the canonical psychological account of characteristic expectations, emotions, and behaviors in close relationships; canonical owner is Chapter 1.15. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Attachment style → 1.15 canonical owner (redirect only) has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Individual differences provides the canonical psychological account of systematic ways people vary in psychological characteristics, processes, and behavior. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Individual differences has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality assessment provides the canonical psychological account of systematic measurement of personality characteristics. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality assessment has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Self-report assessment provides the canonical psychological account of assessment based on a person's own reports. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Self-report assessment has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Informant assessment provides the canonical psychological account of assessment based on reports from people who know the target. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Informant assessment has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Behavioral assessment provides the canonical psychological account of assessment using observed or recorded behavior. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Behavioral assessment has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Projective assessment provides the canonical psychological account of methods inferring psychological characteristics from responses to ambiguous stimuli. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Projective assessment has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Response distortion provides the canonical psychological account of systematic alteration of assessment responses away from accurate reporting. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Response distortion has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Social desirability provides the canonical psychological account of tendency to present oneself in socially acceptable or favorable ways. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Social desirability has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
...
Personality measurement validity provides the canonical psychological account of degree to which personality measures support intended score interpretations and uses. It exists to preserve the construct's meaning, mechanism, development or temporal behavior, evidence status, and boundaries within the architecture of personality, self, identity, and individual differences.
...
- Personality measurement validity has a defined explanatory scope and should not become a catch-all label.
- Person-level characteristics can be expressed differently across situations.
- Stability and change can coexist across different time scales.
- Measurement evidence must be interpreted according to what the method actually captures.
- Relationships with neighboring constructs should be explicit rather than treated as identity.
