...
Mechanism identification requires separating the decision target from the process that produces its representation. A person can reach an adequate judgment through retrieval, comparison, simulation, or a shortcut, and the same strategy can produce different results when the environment changes. This makes transfer especially informative: a process that survives changes in surface features but fails when the relevant structure changes reveals something different from a response tied to one familiar task. Development and expertise can also change which operations are effortful, so apparent differences between people may reflect knowledge and practice rather than a single decision capacity. Cultural context can alter norms, reference points, and acceptable tradeoffs without implying that the underlying process is wholly culture-specific. Strong evidence therefore combines repeated observations with controlled manipulations and avoids inferring a stable trait from one decision episode.
...
A further distinction is between uncertainty in the world and uncertainty in the observer's model. A decision-maker may know that an outcome is random while being uncertain about its distribution, or may have a precise subjective belief that happens to be poorly calibrated. Learning can reduce some uncertainty, while irreducible stochasticity remains. The psychological response also depends on whether uncertainty is treated as an opportunity for information search, a reason to delay, or a feature to tolerate. This means that two people facing the same objective problem can make different choices without either necessarily violating a coherent process. Measurement should therefore identify the information set available at the moment of choice and distinguish ignorance from genuine environmental randomness.
...
The distinction among risk, uncertainty, and ambiguity also matters for intervention and learning. If probabilities are unknown but learnable, information acquisition can change the decision problem; if the environment is intrinsically stochastic, additional information may improve prediction only up to a limit. Psychological responses to these states can also be shaped by perceived control and prior experience. The construct therefore concerns the information structure, not merely how uncomfortable the person feels.
...
A formal model should be read at three levels: its assumptions, its mathematical implications, and its empirical adequacy. An elegant model can be normatively useful even if humans systematically depart from it, while a descriptively successful model may summarize behavior without identifying the cognitive mechanism that produced it. Parameters can also vary by person, context, stakes, and domain. Model comparison is strongest when competing accounts make different predictions under controlled changes in information or incentives. This prevents a common error in decision science: treating a mathematical representation as though it were a literal psychological process. Models are tools for organizing predictions and clarifying criteria, and their psychological interpretation must be supported independently.

Models should also be evaluated for scope. A theory designed to explain risky choice should not automatically be generalized to moral judgment, group coordination, or every preference. Parameters that fit one population or task may not transfer unchanged. A model becomes psychologically informative when its assumptions correspond to observable processes and when competing models make discriminable predictions. Otherwise it remains a useful formal language rather than an established mechanism.
...
The value of a heuristic is relational. A cue is useful when it preserves information about the target at a cost lower than exhaustive analysis, and the same cue can become misleading when the environment changes. Heuristics can therefore be adaptive without being infallible. Expertise may improve cue selection, calibration, or stopping rather than eliminating the use of shortcuts. Individual differences can also arise because people have different knowledge of the environment in which a cue is diagnostic. Experimental tests should manipulate cue validity, availability of alternative information, time pressure, and feedback. This distinguishes the strategy itself from the conditions under which it succeeds or fails.

A heuristic should be evaluated against realistic alternatives available to the person, not against an impossible ideal. Search has costs, information can be noisy, and the environment can reward speed. At the same time, a heuristic can become maladaptive after environmental change or when a cue loses validity. This makes ecological calibration central to interpretation and explains why the same strategy can produce different accuracy across domains.
...
A named effect is not a mechanism. The same change in judgment can result from altered attention, reference points, memory accessibility, inference, social information, or response demands. Establishing an effect therefore requires more than observing a mean difference; it requires a comparison that isolates the relevant manipulation and considers whether participants interpreted the options as intended. Effect sizes can also vary with task wording, population, stakes, and familiarity. Replication across procedures is useful, but heterogeneity is not automatically evidence against the phenomenon because boundary conditions may be part of the phenomenon's definition. The strongest account specifies both the effect and the conditions that produce it.

Boundary conditions are part of the construct's scientific description. An effect that appears only under particular reference points, incentives, populations, or task formats should not be treated as universal, but neither should its conditionality erase the phenomenon. The right question is what variables moderate the effect and whether those moderators correspond to a plausible process.
...
Repeated observations are essential because confidence and accuracy fluctuate. Calibration can be examined globally, locally, across probability bins, or by domain. A person may be well calibrated on average while poorly calibrated at extreme confidence levels, or accurate because of knowledge while still expressing inappropriate certainty in unfamiliar cases. Feedback can improve calibration, but only when it is timely, diagnostic, and interpreted correctly. Stakes and incentives can also change reporting without changing underlying belief. Confidence should therefore be measured separately from probability, accuracy, response time, and outcome quality.

Calibration can be decomposed into discrimination and reliability. A person may distinguish high-probability from low-probability events while being systematically too extreme, or may be unbiased on average while failing to discriminate cases. Calibration analysis therefore benefits from multiple confidence levels, repeated predictions, and appropriate scoring rules rather than binary accuracy alone.
...
Belief change is temporally structured. Information must be noticed, interpreted, assigned evidential weight, integrated with existing representations, and retained long enough to affect later judgment. At any stage, memory, attention, identity, emotion, or social context can alter what information reaches the belief system. A persistent belief can therefore reflect weak evidence, strong competing explanations, poor integration, or selective processing. Conversely, belief revision can occur without full understanding of the underlying evidence. Longitudinal designs and controlled evidence changes are especially informative because they distinguish immediate response from durable updating.

Belief processes also interact with memory and identity. Evidence that is well encoded may still fail to revise a belief if its implications are not integrated with existing causal or social representations. Conversely, a belief can change because its supporting representation becomes inaccessible rather than because the underlying evidence was understood differently. Longitudinal measurement is therefore essential when the claim concerns persistence or durable change.
...
A bias should be treated as a patterned discrepancy relative to a criterion, not as a statement about a person's character. The criterion may be probability theory, an explicit task instruction, a decision rule, or a person's stated goal. A behavior can look biased under one benchmark and adaptive under another. This is especially important when the environment is uncertain or feedback is sparse, because an apparently inaccurate judgment may reflect rational use of incomplete information. Bias research therefore benefits from specifying the reference class, information set, outcome criterion, and alternative explanations. Repeated measures can reveal whether the pattern is stable, state-dependent, learned, or sensitive to context.

The benchmark itself should be made explicit. A statistical optimum, a person's stated goal, a social norm, and a formal economic model can generate different assessments of the same response. Scientific writing should therefore report the criterion before labeling an outcome a bias. This also helps distinguish adaptive simplification from systematic error.
...
Choice phenomena are inseparable from the structure of the choice set. Adding, removing, ordering, labeling, or preselecting options can alter search and comparison without changing the underlying consequences. This means a person's choice can be partly a property of the person-environment system rather than a stable internal preference. Repeated choices across altered environments help identify what remains stable. The same principle applies to individual differences: a person who appears indecisive under high complexity may make rapid and consistent choices when attributes are structured clearly. Decision analysis should therefore examine both the agent and the architecture surrounding the agent.

Choice effects should be tested for persistence. A temporary shift during an experiment is not necessarily a durable preference change, and a repeated choice can reflect learning about the environment rather than stable valuation. Separating immediate response, later behavior, and transfer to new option sets helps determine whether an observed effect belongs to the decision episode or to a broader pattern.
...
Affective decision phenomena require temporal and functional precision. Immediate affect can serve as information about an option, while anticipated affect can shape future choice, and retrospective affect can influence learning after an outcome. These are not interchangeable. Emotion can also change attention and memory before valuation occurs, so an observed affective influence does not prove that the final choice was caused directly by feeling. Strong analysis identifies when affect entered the process, what information it carried, and whether it improved or degraded performance relative to the task criterion.

Affective influences also require comparison with the task's objective criterion. A feeling can be informative when it summarizes relevant experience and misleading when it reflects an unrelated source. The presence of emotion is therefore not itself evidence of irrationality. What matters is whether the affective cue carries information about the target and how it interacts with other evidence.
...
Naturalistic decisions are embedded in environments that provide cues, feedback, routines, institutional rules, and consequences. Expertise can make a strategy appear effortless because extensive learning has compressed recognition and action selection. But ecological fit is critical: a strategy learned in a stable environment can fail after distributional change. Naturalistic research therefore asks not simply whether intuition is fast, but whether the environment provides reliable regularities, whether feedback is available, and whether the decision-maker has had enough experience to learn those regularities. This makes expertise and environment inseparable parts of interpretation.

Naturalistic evidence also benefits from failure analysis. Experts can make rapid errors when cues are misleading, feedback is absent, or the environment changes. Conversely, deliberate analysis can be inefficient when the task rewards rapid recognition. The scientific question is therefore conditional: which strategy works, for whom, under what environmental regularities, and with what feedback?

Dual-process accounts also face a measurement problem: speed, effort, accuracy, and subjective experience do not map cleanly onto one processing category. A slow response can reflect difficult automatic processing, deliberate correction, or simple lack of knowledge; a fast response can reflect expertise rather than an uncontrolled default. Contemporary interpretation therefore treats dual-process language as a family of functional distinctions whose usefulness depends on the task. The strongest evidence comes from manipulations that selectively alter working-memory demand, time pressure, incentives, information, or cognitive control and then test whether the predicted change occurs. This avoids reifying “System 1” and “System 2” into literal anatomical entities.
...
Environmental decision effects should be evaluated as person-environment interactions. A design feature can reduce effort for one population and create confusion for another, or improve outcomes under one goal while impairing another. Effects may also depend on whether people notice the intervention, understand its meaning, trust the source, and have meaningful alternatives. Scientific analysis therefore requires population, context, implementation, and outcome criteria rather than treating an intervention label as sufficient explanation.

Environmental interventions should be assessed for mechanism, not only aggregate effect. If a default changes behavior, researchers should ask whether the change came from inertia, perceived recommendation, effort reduction, or altered attention. Different mechanisms imply different generalization patterns and different consequences when the intervention is removed or reversed.

Naturalistic decision-making is particularly valuable for studying competence under conditions that laboratory tasks can remove. Real decisions often contain incomplete cues, evolving goals, interruptions, feedback, social coordination, and consequences that unfold over time. Recognition-primed approaches and related models describe how experienced decision-makers can rapidly generate a plausible course of action and mentally test it rather than comparing every option exhaustively. Such strategies can be adaptive when the environment is structured and feedback is available. They can fail when the cue structure changes, feedback is delayed, or expertise is transferred outside its original domain. The construct therefore links cognition to ecology rather than declaring intuition globally good or bad.
...
Choice architecture is broader than any single intervention. It includes the number and grouping of options, order, defaults, timing, friction, labeling, information display, reminders, and opportunities for feedback. These features alter what is easy to notice, compare, remember, or execute. A choice architecture can therefore affect behavior without changing the underlying objective consequences. Scientific analysis must separate the effect of the architecture from the person's prior preferences and from institutional constraints. It should also examine whether the effect persists when the architecture changes, whether people understand the arrangement, and whether different populations experience the same structure differently.
...
Nudging is an empirical and normative concept at once. Empirically, the question is whether a small change in the choice environment predictably shifts behavior through mechanisms such as default retention, salience, simplification, or social information. Normatively, preserving options does not by itself settle whether an intervention is appropriate; that is a separate ethical question. Psychological analysis should remain descriptive about how the intervention works and should specify the population, target behavior, baseline, implementation fidelity, and durability of the effect. A nudge can also fail, reverse, or create unintended substitution effects, so its label cannot substitute for measurement.
...
Debiasing can target the individual, the decision procedure, or the environment. Individual strategies may prompt base-rate consideration, alternative hypotheses, confidence calibration, or delay of commitment. Procedural strategies can change information presentation, require independent estimates before discussion, or introduce structured comparison. Environmental strategies can improve defaults, feedback, or information quality. Different approaches address different sources of error, and an intervention that works on one bias may not generalize to another because the mechanisms differ. Evaluation should therefore specify the target error, criterion, baseline, transfer task, and durability. Increased deliberation or confidence is not sufficient evidence of successful debiasing if accuracy or decision quality does not improve.
...
Moral decision processes require a distinction between descriptive and normative analysis. Psychology can study how people weigh harm, fairness, duty, responsibility, identity, and consequences, but those observations do not settle which moral principle is correct. Moral judgments can also be sensitive to framing and social norms, making them context-dependent without being arbitrary. Cross-cultural and developmental variation is especially important because the content and priority of moral considerations can differ while the underlying capacity for norm-sensitive evaluation remains.

Moral decision research also needs to separate judgment from action. People can endorse a moral principle yet behave differently when incentives, uncertainty, social pressure, or competing obligations change. A moral judgment therefore should not be inferred solely from behavior, and behavior should not be treated as a direct measure of moral conviction.

Decision errors require an explicit benchmark because “error” is not a property of an outcome alone. A decision can produce a bad result through bad luck, while a poor process can occasionally produce a favorable result. Possible criteria include probability accuracy, logical validity, goal attainment, expected utility, consistency with stated preferences, safety constraints, or a task-specific rule. These criteria can conflict, so the analyst must state which one is being used. Error diagnosis then asks where the process diverged: problem framing, information search, representation, prediction, valuation, comparison, stopping, or implementation. This stage-sensitive approach is more informative than labeling the final choice as simply rational or irrational.
...
Collective choice introduces emergent properties because members influence one another while information is distributed unevenly. A group can outperform individuals when information is independent and aggregation is effective, yet underperform when discussion causes correlated errors or suppresses dissent. Leadership, status, communication structure, incentives, and accountability can alter these dynamics. Group decision-making should therefore be analyzed at both member and interaction levels. A group's final decision cannot be explained simply by averaging individual preferences because discussion can change the information, confidence, and preferences that members bring to the final choice.

Group processes require temporal analysis because early discussion can change later individual judgments. Information may be repeated until it appears more credible, dissent may disappear, or a shared frame may emerge. Group decision quality therefore depends not only on who is present but on how information moves through the interaction and whether independent information remains independent.

Group decision-making also requires distinguishing aggregation from interaction. If members contribute independent information, pooling can improve estimation; if they influence one another before independent judgments are recorded, correlated errors can spread through the group. Communication can reveal hidden information or make repeated information appear disproportionately important. Status, leadership, social norms, accountability, and conflict management can alter whose information is heard and how dissent is treated. Groups can therefore be simultaneously more knowledgeable and more vulnerable than their individual members. Measurement should track information distribution, discussion sequence, individual judgments before and after interaction, final consensus, and the degree to which the group preserves independent evidence.
