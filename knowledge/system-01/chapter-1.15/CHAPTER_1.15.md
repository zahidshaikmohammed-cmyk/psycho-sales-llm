...
Development is the broad organizing concept for understanding systematic change and continuity in psychological functioning across the lifespan. This Topic establishes what counts as developmental change and provides the foundation for the more specific processes, domains, stages, and systems covered elsewhere in this chapter.

## 2. Definition

Development is the systematic pattern of change, stability, and reorganization in an individual's biological, psychological, and behavioral functioning across time.

Development includes gains, losses, qualitative transformations, and continuity. It is not synonymous with improvement, growth, maturation, or childhood.

## 3. Core Understanding

### Components / Dimensions

Development can involve changes in structure, function, behavior, representation, capacity, regulation, relationships, and adaptation. Some changes are quantitative, such as increases in vocabulary. Others are qualitative, such as a reorganization in how a person reasons about another person's beliefs.

Development also includes stability. A developmental account therefore asks not only what changed, but what persisted, what changed at different rates, and how earlier organization relates to later functioning.

### Mechanism

Development arises through interacting biological, psychological, social, and environmental processes. Genetic activity, maturation, learning, experience, relationships, cultural practices, and self-directed activity can contribute to developmental trajectories. These influences are usually interdependent rather than separable causes operating in isolation.

Developmental mechanisms may produce both continuity and transformation. The same experience can have different effects depending on developmental timing, prior functioning, social context, and available resources.

### Development

Development is not restricted to early life. Human capacities and patterns can continue to reorganize during adolescence, adulthood, and older age. Some capacities show substantial plasticity while others become more constrained with age or accumulated experience.

### Moderators / Boundary Conditions

Development differs between people. Biological variation, family conditions, socioeconomic circumstances, culture, education, health, historical period, and individual choices can alter developmental pathways. A population-level developmental pattern therefore does not determine the trajectory of a particular individual.

### Evidence Status

Developmental claims require evidence across time or evidence capable of distinguishing age, cohort, and period effects. Cross-sectional age differences alone cannot establish that an individual's functioning changed with age because different age groups may have different life histories.

### Development as a process rather than a single outcome
Development is best understood as an organized temporal process. A developmental description asks how a pattern comes to have its present form, what earlier states made later states possible, and what conditions alter the path. This differs from simply recording that two age groups differ. Developmental explanation requires attention to temporal ordering and to the processes that connect earlier and later functioning.

A developmental trajectory can contain gains, losses, reorganizations, plateaus, and reversals. A child may acquire a new capacity while temporarily becoming less efficient at an older strategy; an adult may preserve knowledge while losing processing speed; an older person may compensate for a decline in one function by relying more heavily on accumulated knowledge or environmental supports. Development therefore cannot be reduced to a single upward scale of maturity.

### Quantitative and qualitative change
Quantitative change concerns amount, frequency, speed, accuracy, complexity, or magnitude. Qualitative change concerns organization: a system may begin operating according to a different structure or strategy. The distinction is useful but not absolute. A gradual quantitative accumulation can eventually produce a qualitative reorganization, while a qualitative transition can depend on many small quantitative changes. Developmental research therefore examines both the amount of change and the organization of the changing system.

### Multiple timescales
Development can occur over minutes, days, months, years, or generations. Learning a new response can alter behavior quickly, whereas biological maturation or changes in social role may unfold over much longer periods. Short-term change can also become part of long-term development when repeated experiences alter habits, knowledge, relationships, or opportunities. A lifespan account therefore connects immediate processes with longer trajectories rather than treating them as separate kinds of change.

### Individual trajectories
Average developmental patterns describe populations, not destinies. People who share an age can differ substantially in timing, sequence, rate, and outcome. Some variation reflects biological differences; some reflects experience, opportunity, culture, health, relationships, education, and historical circumstances. Developmental science is therefore concerned with both normative patterns and individual differences in pathways.

### Cumulative and transactional processes
Earlier development can change the conditions under which later experiences occur. A developing child who becomes more verbally skilled can elicit different responses from caregivers and teachers; those responses can then provide new learning opportunities. The person is therefore not merely acted upon by an environment. People select, shape, interpret, and sometimes transform their environments, while environments simultaneously constrain and enable development. This reciprocal pattern is central to understanding why development is dynamic rather than mechanically predetermined.

## 4. Relationship to This Chapter

Development is the chapter's umbrella concept. The chapter's developmental mechanisms, domains, lifespan stages, and developmental systems specify different ways development can be studied.

## 5. Boundaries

### Owns

The general psychological concept of development as systematic change and continuity across time.

### Defers

Specific developmental mechanisms, domains, stages, and systems to their dedicated Topics. General learning, memory, personality, motivation, emotion, and other psychological constructs remain owned by their canonical chapters.

## 6. Key Principles

- Development includes both change and stability.
- Development is not equivalent to improvement.
- Development occurs across the lifespan.
- Development usually reflects interacting biological, psychological, social, and environmental processes.
- Age differences do not automatically prove developmental change.


### Topic-specific evidence layer


A developmental claim is strongest when the time structure of the evidence matches the claim being made. Repeated observations of the same people can reveal within-person trajectories, whereas comparisons between age groups primarily reveal differences between groups unless additional design features separate age from cohort and period. Even longitudinal evidence does not automatically identify the mechanism producing change. A trajectory may reflect maturation, learning, altered opportunity, changing relationships, health, selection, or several processes operating together. Developmental interpretation therefore benefits from specifying the proposed process, the interval over which it operates, and the conditions under which the pattern changes. This also protects against deterministic readings of developmental findings. Population-level regularities can describe probabilities or common pathways without fixing the future course of an individual. The same principle applies when interpreting stability: persistence may coexist with meaningful reorganization in another component of the same developmental system.

Evidence focus: distinguish development as an organized temporal process from simple improvement, age difference, or isolated fluctuation.
Development should be interpreted as an organized temporal process rather than a synonym for getting better. A developmental trajectory can contain acquisition, consolidation, differentiation, compensation, reorganization, loss, and renewed adaptation. The same person can therefore show improvement in one domain while experiencing constraint in another. This makes developmental description inherently multidimensional.

The strongest developmental explanations connect earlier and later states through identifiable processes. Age is a coordinate, not a mechanism. A finding that a behavior differs between age groups establishes a group difference but does not by itself establish within-person change. Cohort, period, selection, health, education, and historical conditions may contribute.

Development is also probabilistic. Earlier experiences can alter later opportunities and expectations without fixing the future. Reciprocal interaction means that people influence their environments while environments influence them. This is why developmental pathways can show both continuity and revision.
...
This Topic establishes the lifespan perspective: development is studied as a process extending from prenatal life through later adulthood rather than as a phenomenon limited to childhood.

## 2. Definition

Lifespan development is the scientific study of patterns of continuity and change in human functioning from the earliest stages of life through old age and dying.

## 3. Core Understanding

### Components / Dimensions

A lifespan perspective considers multiple domains of functioning, including biological, cognitive, emotional, social, personality, self, and identity development. These domains can develop at different rates and can influence one another.

### Mechanism

Lifespan development reflects the interaction of maturation, experience, learning, social relationships, historical context, culture, health, and individual agency. Development may involve gains in one capacity alongside losses or constraints in another.

The lifespan perspective also recognizes that development is multidirectional. People can gain knowledge while experiencing reductions in some forms of processing speed, for example. Development therefore cannot be represented adequately by a single upward or downward scale.

### Development

Different periods can have different developmental tasks and opportunities. Early development often involves rapid changes in basic capacities, whereas later development may involve refinement, compensation, adaptation, reorganization, and selective maintenance.

### Moderators / Boundary Conditions

Historical period and cohort matter. People born in different periods may encounter different technologies, educational systems, social norms, health conditions, wars, economic conditions, and cultural expectations. Apparent age effects can therefore partly reflect cohort differences.

### Evidence Status

Longitudinal, cross-sectional, and sequential designs answer different questions. Longitudinal studies directly observe within-person change but can be affected by attrition and repeated-testing effects. Cross-sectional studies compare age groups efficiently but confound age with cohort. Sequential designs help separate these influences.

### The lifespan as an integrated system
A lifespan perspective rejects the assumption that development has one universal direction. Different capacities have different timing. Biological growth may dominate some periods, while social-role transitions, accumulated knowledge, health changes, or adaptation become more influential in others. Developmental gains and losses can occur within the same period and even within the same ability.

### Major lifespan principles
Lifespan approaches commonly emphasize multidirectionality, plasticity, historical embeddedness, and the interaction of gains and losses. Multidirectionality means that development can move in different directions across domains. Plasticity means that functioning can sometimes be modified by experience or intervention, although plasticity is neither unlimited nor identical across individuals. Historical embeddedness means that people develop within particular economic, technological, cultural, and historical conditions.

### Age, period, and cohort
Age-related change must be distinguished from period effects and cohort effects. A period effect occurs when an event or condition affects many age groups at the same historical time. A cohort effect occurs when people born or entering a life stage during a particular period share experiences that distinguish them from other cohorts. These effects can overlap, making age differences difficult to interpret without appropriate research designs.

### Gains, losses, and adaptation
Lifespan development includes acquisition as well as maintenance and compensation. A person may lose speed but retain accuracy by slowing down. A person may have fewer social contacts but greater selectivity in which relationships receive attention. Such patterns illustrate that adaptation is not simply the absence of decline. It can involve changing goals, strategies, environments, and resource allocation in response to developmental conditions.

### Contextual embeddedness
Development occurs within nested contexts: immediate relationships, schools and workplaces, communities, institutions, cultural systems, and historical periods. Context does not merely surround development; it changes the opportunities and constraints through which development unfolds. The same biological transition can therefore have different psychological implications in different environments.

### What the lifespan perspective does not claim
A lifespan approach does not claim that every human characteristic changes continuously from birth to death. Some characteristics are relatively stable for long periods; others change sharply; still others show different patterns across people. The central claim is methodological and conceptual: development should be studied as an ongoing pattern of change and continuity across the entire life course.

## 4. Relationship to This Chapter

Lifespan development provides the temporal framework within which the chapter's developmental stages and domains are organized.

## 5. Boundaries

### Owns

The lifespan framework for understanding human development across the full life course.

### Defers

Specific developmental stages, domains, mechanisms, and systems to their dedicated Topics.

## 6. Key Principles

- Development extends across the lifespan.
- Development is multidirectional and multidimensional.
- Gains and losses can coexist.
- Age, period, and cohort must be distinguished.
- No single developmental trajectory represents every person.


### Topic-specific evidence layer


Evidence focus: interpret lifespan patterns across gains, losses, adaptation, historical context, and differences among developmental domains.
Lifespan development is a framework for treating development as continuous across the entire life course. Its value is partly corrective: childhood is not the whole of development, and adulthood is not merely a static endpoint. Different periods contain different combinations of biological change, learning, social roles, accumulated knowledge, and adaptation.

A lifespan perspective is also explicitly multidirectional. Gains and losses can occur together. A person may acquire expertise while processing speed changes, develop stronger emotional selectivity while reducing the size of a social network, or gain autonomy while assuming greater responsibility. These are developmental reorganizations rather than simple movement upward or downward.

Historical embeddedness is essential. People of the same age may have grown up under different educational, technological, economic, and cultural conditions. Age, period, and cohort therefore require separate interpretation. Sequential and longitudinal designs can help, but no design removes the need for careful reasoning about historical context.
...
This Topic isolates the concept of change itself so that developmental change is not confused with simple age difference, maturation, or improvement.

## 2. Definition

Developmental change is a systematic within-person alteration in psychological, biological, behavioral, or social functioning across developmental time.

## 3. Core Understanding

### Mechanism

Developmental change can result from maturation, learning, experience, biological adaptation, social interaction, environmental change, or combinations of these processes. The source of a change must be established rather than assumed from its timing.

### Types / Forms

Change can be quantitative, such as increasing knowledge or vocabulary; qualitative, such as a reorganization of representation; continuous, involving gradual shifts; or discontinuous, involving relatively distinct reorganizations.

Change can also be domain-specific. A person may change substantially in one domain while remaining comparatively stable in another.

### Boundary Conditions

Age-related change should be distinguished from age-group differences. A cross-sectional finding that older adults differ from younger adults does not by itself establish that individuals acquire that difference as they age.

Developmental change can also vary in timing, magnitude, direction, and reversibility.

### Evidence Status

Strong claims about developmental change generally require designs capable of tracking individuals over time or otherwise separating age, cohort, and period effects.

### Forms of developmental change
Developmental change can involve quantity, structure, strategy, timing, efficiency, differentiation, integration, or coordination. A vocabulary may expand in size while also becoming organized into increasingly specialized semantic categories. A child's social understanding may become more differentiated as the child learns to represent different perspectives. An older adult may change strategy rather than simply lose capacity. These forms should not be collapsed into one generic idea of improvement.

### Within-person change
Developmental change is fundamentally a within-person concept. Researchers may compare people of different ages, but the theoretical question concerns how functioning changes within individuals over time. Longitudinal designs are especially useful because they follow the same participants, although even longitudinal evidence can be affected by practice effects, selective attrition, measurement changes, and historical context.

### Rate and timing
Two people can reach a similar outcome through different trajectories. One may acquire a skill early and then plateau; another may develop gradually and catch up later. Timing can matter because opportunities and constraints depend on developmental context. The same experience may have different effects when it occurs during different developmental periods. Therefore, developmental change is characterized not only by direction but also by rate, sequence, and timing.

### Mechanisms linking earlier and later states
A developmental claim is stronger when it identifies a plausible process connecting earlier functioning with later functioning. Mechanisms can include maturation, learning, social interaction, changes in representation, practice, biological adaptation, and altered environmental demands. A statistical association between early and later measures does not by itself identify which mechanism produced the continuity.

### Heterogeneity of change
Average change can conceal multiple individual trajectories. Some people improve rapidly, some gradually, some remain stable, and some decline. Modern developmental analysis therefore increasingly examines variability rather than treating the group mean as the complete developmental story. Heterogeneity can itself be theoretically informative because different trajectories may reflect different mechanisms or contexts.

## 4. Relationship to This Chapter

Developmental change is one of the chapter's central temporal concepts and connects directly to continuity, discontinuity, stability, plasticity, and lifespan development.

## 5. Boundaries

### Owns

The general concept of within-person developmental change.

### Defers

Specific forms of change, such as cognitive aging, personality development, language development, and emotional development, to their respective Topics.

## 6. Key Principles

- Developmental change is fundamentally about change across time.
- Age difference is not automatically developmental change.
- Change can be quantitative or qualitative.
- Different domains can change differently.


### Topic-specific evidence layer


Evidence focus: establish change through defined intervals and within-person evidence rather than treating age-group differences as change.
Developmental change is specifically concerned with alteration within a person across time. The important distinction is between observing a difference and observing a change process. A cross-sectional difference can be informative, but it is not equivalent to watching an individual acquire the later state.

Change can occur in amount, organization, strategy, efficiency, timing, coordination, or differentiation. A person may become faster, know more, use a different strategy, coordinate previously separate abilities, or reorganize an existing representation. These forms can occur together, but they should not be collapsed into a single metric of improvement.

Rate and timing also matter. Two people can reach a similar endpoint through different trajectories, and a temporary regression can occur during reorganization. Developmental change should therefore be represented as a trajectory with direction, magnitude, timing, and context rather than as a before-and-after label.
...
This Topic explains how developmental change and continuity can arise without reducing development to a single cause.

## 2. Definition

Developmental mechanisms are the processes through which biological, psychological, social, and environmental influences produce or maintain developmental patterns over time.

## 3. Core Understanding

### Mechanism

Developmental mechanisms can include maturation, gene expression, neural plasticity, learning, social interaction, attachment processes, imitation, instruction, self-regulation, environmental selection, and reciprocal person–environment transactions.

A mechanism is an explanatory process, not merely a factor correlated with development. For example, saying that schooling is associated with cognitive development identifies a relationship; specifying changes in knowledge, practice, strategy use, and opportunities for guided learning begins to describe mechanisms.

Development is often transactional. A child's characteristics influence how other people respond to the child, while those responses influence subsequent development. People also select, modify, and create environments that feed back into their development.

### Development

Mechanisms can change in importance across the lifespan. Biological maturation may be especially prominent at some points, while accumulated knowledge, social roles, deliberate practice, and environmental adaptation become increasingly important elsewhere.

### Moderators / Boundary Conditions

Timing matters. The same exposure can have different consequences depending on developmental stage, prior experience, biological sensitivity, social support, and environmental context.

### Evidence Status

Mechanistic claims require stronger evidence than simple age associations. Experimental, longitudinal, genetically informed, and natural-experiment designs can provide different forms of evidence about developmental processes.

### What makes a developmental mechanism
A developmental mechanism is a process that helps explain how earlier conditions are transformed into later patterns of functioning. Mechanisms can operate at biological, cognitive, behavioral, interpersonal, institutional, and cultural levels. They are not merely descriptions of outcomes. Saying that a skill improves with age describes a pattern; identifying learning, neural maturation, practice, or changing social demands provides a possible mechanism for that pattern.

### Interacting mechanisms
Development rarely has one isolated cause. Biological maturation can alter attention or motor capacity, which changes what experiences are possible. Experience can then alter behavior and expectations, which can influence subsequent opportunities. Social relationships can amplify or constrain these processes. Mechanisms therefore often form feedback systems rather than linear chains.

### Transactional processes
In transactional development, person and environment continuously influence one another. A child's behavior affects caregiver responses; caregiver responses affect the child's behavior; both are embedded in broader conditions. This does not mean that every influence is equal. It means that developmental pathways can be generated through repeated reciprocal interactions.

### Timing and mechanism
The same mechanism can have different consequences depending on developmental timing. Learning opportunities may be especially influential when a relevant capacity is becoming organized, while later experience may consolidate, modify, or compensate for earlier patterns. Timing should therefore be treated as part of the mechanism rather than as a simple background variable.

### Mechanism versus explanation label
Terms such as maturation, socialization, or experience can become vague if used as labels without specifying what process occurred. A rigorous developmental explanation asks what changed, through what process, under what conditions, and with what evidence. Mechanistic language should therefore be tied to observable processes and should remain appropriately qualified when direct causal evidence is limited.

## 4. Relationship to This Chapter

Developmental mechanisms connect the chapter's broad concept of development to specific domains, stages, and systems.

## 5. Boundaries

### Owns

General explanatory mechanisms of developmental change and continuity.

### Defers

Specific mechanisms owned by other psychological chapters, such as learning mechanisms, memory mechanisms, motivational mechanisms, and neural mechanisms.

## 6. Key Principles

- Development is produced by interacting processes.
- A correlate is not automatically a mechanism.
- Developmental mechanisms can change in importance across time.
- Timing and context can alter developmental effects.


### Topic-specific evidence layer


Evidence focus: identify interacting biological, psychological, social, and environmental processes without treating any single influence as sufficient.
Developmental mechanisms answer the explanatory question of how developmental patterns are generated. A mechanism is more than a variable associated with age. It specifies a process through which earlier conditions alter later functioning. Learning, maturation, practice, social feedback, biological adaptation, environmental selection, and reciprocal interaction can all serve as mechanisms depending on the question.

Mechanisms can interact. A biological change can alter behavior, behavior can change the environment, the new environment can create learning opportunities, and learning can alter later behavior. Such feedback means that development often resembles a changing system rather than a one-way causal chain.
...
# 5. Developmental systems perspective

## 1. Purpose

This Topic provides a systems-level way to understand development as an organized interaction among biological, psychological, social, and environmental processes.

## 2. Definition

The developmental systems perspective views development as the product of dynamic, reciprocal relations among the developing person and multiple levels of biological, psychological, social, cultural, and environmental organization.

## 3. Core Understanding

### Mechanism

Development is treated as emerging from interactions rather than being driven by a single independent source. Biological processes affect behavior, behavior changes environments, environments alter experience, and experience can influence subsequent biological and psychological functioning.

The perspective therefore rejects simple one-way explanations such as genes determining development or environment determining development. Both biological and environmental processes participate in developmental organization, with their effects depending on timing and context.

### Components / Dimensions

Relevant levels can include genes and physiology, neural systems, behavior, cognition, emotion, relationships, family, school, community, culture, and historical context. The exact levels studied depend on the developmental question.

### Moderators / Boundary Conditions

A systems explanation must remain specific enough to be testable. Saying that everything influences everything is not itself a mechanism. Useful developmental systems research identifies particular pathways, interactions, temporal sequences, and boundary conditions.

### Theory / Model

The developmental systems perspective is a family of theoretical approaches rather than one single predictive model. Its central commitment is to reciprocal, multilevel developmental organization.

### Evidence Status

The perspective is useful as an organizing framework, but individual causal claims still require empirical testing. A systems perspective does not make every proposed interaction empirically established.

### Development as an organized system
The developmental systems perspective treats development as emerging from relations among multiple levels of organization rather than from a single source such as genes or environment. Biological processes, behavior, relationships, institutions, and cultural practices can interact over time. The unit of explanation is therefore often the changing person-in-context rather than an isolated trait.

### Levels of organization
Relevant levels may include gene expression, neural and physiological systems, behavior, cognition, interpersonal relationships, families, schools, communities, and cultural institutions. A higher-level pattern can alter lower-level conditions, while lower-level changes can contribute to higher-level outcomes. This does not mean that all levels must be studied in every investigation; it means that developmental explanations should not assume in advance that one level is sufficient.

### Emergence and organization
Some developmental outcomes are emergent: they arise from coordinated interactions among components and cannot be understood fully by examining one component alone. Self-regulation, for example, depends on interacting cognitive, emotional, motivational, physiological, and contextual processes. The developmental task is to identify which relations matter rather than simply listing every possible influence.

### Stability within change
Systems perspectives can explain why development contains both stability and change. A system can preserve an organized pattern while individual components change, or a small alteration can destabilize an established pattern and lead to reorganization. Stability therefore does not necessarily mean that nothing changes; it can mean that the overall organization remains recognizable despite component-level changes.

### Limits of the perspective
A systems framework is not itself proof of any particular causal relationship. It is an organizing approach that encourages attention to interacting processes, multiple timescales, and context. Specific claims still require empirical evidence. The perspective should not become a license to assert that every variable causes every other variable.

## 4. Relationship to This Chapter

It provides the broad theoretical framework connecting developmental mechanisms, domains, stages, and contextual influences.

## 5. Boundaries

### Owns

The systems-level framework for conceptualizing development.

### Defers

Specific biological, cognitive, social, cultural, and learning mechanisms to their canonical owners.

## 6. Key Principles

- Development is multilevel and relational.
- Person and environment influence one another.
- Biological and environmental explanations are not mutually exclusive.
- A systems framework does not substitute for evidence about specific mechanisms.


### Topic-specific evidence layer


Evidence focus: use systems reasoning to specify relevant interacting levels and avoid turning every contextual factor into an equally important cause.
The developmental systems perspective is most useful when a developmental pattern cannot be explained adequately at one level. Genes, physiology, neural organization, behavior, cognition, relationships, family systems, schools, communities, culture, and historical conditions can participate in the same trajectory. The perspective does not require every level to be measured in every study; it requires the explanation to remain open to interactions across levels when those interactions are relevant.

A systems account must remain testable. Saying that everything affects everything is not an empirical mechanism. Useful systems explanations specify which components interact, the direction or reciprocity of influence, the timing of those interactions, and the conditions under which the relationship changes.

Developmental systems thinking also clarifies emergence. Some outcomes arise from coordinated relations among components rather than from one component alone. Self-regulation, identity, social competence, and adaptation can each involve multiple processes whose organization changes over time.
...
This Topic clarifies how inherited biological characteristics and environmental experience jointly contribute to development.

## 2. Definition

Nature–nurture interaction refers to the interdependence of biological inheritance and environmental experience in shaping development, such that the effects of one can depend on the conditions provided by the other.

## 3. Core Understanding

### Mechanism

Genes do not operate independently of environments. Environmental conditions can influence gene expression and biological development, while inherited characteristics can influence how people respond to, select, or evoke environmental experiences.

This produces several distinct ideas that should not be collapsed. Heritability describes variation in a population attributable statistically to genetic differences under particular conditions; it does not indicate that a trait is genetically fixed in an individual.

Gene–environment interaction refers to cases where the effect of an environmental exposure differs depending on genetic variation, or where genetic differences have different observable consequences under different environments.

Gene–environment correlation describes situations in which genetic differences are associated with differences in the environments people experience.

### Boundary Conditions

Effects depend on the population, environment, developmental period, and trait being studied. A genetic contribution does not imply immutability, and environmental influence does not imply that biology is irrelevant.

### Evidence Status

Twin, adoption, family, molecular-genetic, longitudinal, and experimental research provide different forms of evidence. No single design captures the entire nature–nurture relationship.

### Moving beyond the false binary
Nature–nurture interaction refers to the fact that biological characteristics and environmental experiences jointly contribute to development. The phrase should not be interpreted as a contest asking whether genes or environment is more important. Nearly all complex human characteristics develop through their interaction.

### Biological potential and environmental input
Genetic variation can influence developmental tendencies, sensitivity, physiology, and learning potential, while environments provide nutrients, stimulation, relationships, language, education, stressors, opportunities, and constraints. The resulting phenotype reflects processes occurring across these levels. A genetic contribution does not imply inevitability, and an environmental contribution does not imply that biology is irrelevant.

### Gene–environment correlation
People can experience environments partly because of genetically influenced characteristics. Parents provide both genes and environments, children evoke different responses from others, and individuals increasingly select environments compatible with their preferences and abilities. These processes can create correlations between genetic differences and environmental exposure without implying that genes directly encode complex psychological outcomes.

### Gene–environment interaction
An interaction occurs when the effect of one factor depends on the level of another. A particular biological sensitivity may have different consequences under different environmental conditions. Conversely, the same environment may affect people differently depending on biological characteristics. Demonstrating such interactions requires appropriate data and statistical models; simply finding that genes and environment both matter is not sufficient evidence of interaction.

### Epigenetic processes
Experience can influence biological regulation, including mechanisms affecting gene expression. Epigenetic findings are scientifically important, but they should not be simplified into claims that experiences permanently rewrite genes or that every psychological experience produces a specific inherited biological change. Developmental biology is complex, tissue-specific, and context-dependent.

### Implications for developmental interpretation
Nature–nurture interaction means that explanations should avoid both genetic determinism and environmental absolutism. Development is usually probabilistic. Biological predispositions can alter sensitivity to environments, environments can alter developmental pathways, and both operate within broader social and historical systems.

## 4. Relationship to This Chapter

The concept is central to lifespan development because developmental outcomes emerge from biological and experiential processes operating together.

## 5. Boundaries

### Owns

The general conceptual relationship between biological inheritance and environmental experience in development.

### Defers

Specific genes, epigenetic mechanisms, neural processes, learning mechanisms, and heritability methodology to their canonical Topics.

## 6. Key Principles

- Nature and nurture are interacting influences, not competing explanations.
- Heritability is a population statistic, not an individual's genetic destiny.
- Gene–environment interaction differs from gene–environment correlation.
- Environmental influence does not imply absence of biological influence.


### Topic-specific evidence layer


Evidence focus: examine how biological and environmental conditions influence one another across time rather than treating nature and nurture as competing shares.
Nature–nurture interaction is not a contest between two independent causes. Development reflects relations among biological predispositions and environmental experiences, and those relations can change over time. Genetic differences can influence which environments people encounter, while environments can alter the expression of biological potentials.

The interaction can occur through multiple pathways. People may actively select environments that fit their tendencies. Other people may respond differently to the same individual characteristics. Institutions may provide different opportunities to people with different capacities. Experience can also modify biological and psychological systems. These processes make simple percentage accounts of nature and nurture conceptually inadequate.

Interaction should not be interpreted as unlimited malleability. Biological organization constrains possibilities, and environments differ in the opportunities they provide. The developmental question is therefore how particular biological and environmental conditions combine to produce particular trajectories.
...
This Topic explains continuity in development: how earlier patterns can remain meaningfully related to later functioning.

## 2. Definition

Developmental continuity is the persistence or gradual transformation of characteristics, processes, or patterns across developmental time.

## 3. Core Understanding

### Mechanism

Continuity can arise when earlier capacities, experiences, representations, habits, relationships, or biological characteristics contribute to later functioning. Continuity does not require that a characteristic remain identical.

A pattern may preserve its general organization while changing in form. For example, early capacities for social interaction can become increasingly complex without remaining behaviorally identical.

### Types / Forms

Continuity can be quantitative, when a characteristic changes gradually; structural, when organization remains related across time; or probabilistic, when earlier functioning changes the likelihood of later outcomes without determining them.

### Moderators / Boundary Conditions

Continuity can be weakened by new experiences, biological changes, social transitions, interventions, and major environmental shifts. Development therefore involves both continuity and opportunities for reorganization.

### Evidence Status

Longitudinal research is particularly important for studying continuity because it allows relationships between earlier and later functioning to be examined within individuals.

### What continuity means
Developmental continuity refers to persistence or gradual transformation across time. Continuity can involve rank-order stability, mean-level stability, behavioral strategies, representations, relationships, or underlying mechanisms. These forms are not interchangeable. A population can show a stable average while individuals change substantially, or individuals can retain relative ordering while everyone changes in absolute level.

### Gradual transformation
A continuous developmental process may change incrementally rather than through a sharp transition. Language growth, accumulation of knowledge, and increasing practice can often involve many small changes. Continuous development does not mean perfectly smooth development; temporary plateaus, spurts, and fluctuations can occur within an overall gradual trajectory.

### Continuity and transformation can coexist
A later pattern may preserve elements of an earlier pattern while being reorganized into a more complex form. A child's early social preferences, for example, may show continuity in broad interpersonal tendencies while the reasons, strategies, and contexts governing those preferences change. Development therefore should not force a choice between continuity and transformation when both describe different levels of the same trajectory.

### Measuring continuity
Researchers may examine correlations across time, stability coefficients, mean-level change, or qualitative correspondence between earlier and later functioning. High rank-order stability does not mean that no one changed. It means that relative ordering among individuals was preserved to some degree. Measurement reliability also matters because unreliable measures can make stable characteristics appear unstable.

### Sources of continuity
Continuity can arise from persistent biological characteristics, repeated environments, stable relationships, accumulated learning, self-reinforcing behavior, and person–environment transactions. It can also reflect measurement properties. A careful explanation therefore asks which mechanism could maintain the observed pattern rather than treating continuity as self-explanatory.

## 4. Relationship to This Chapter

Continuity is one of the fundamental temporal properties of development and must be interpreted alongside discontinuity, stability, change, and plasticity.

## 5. Boundaries

### Owns

The general developmental concept of continuity.

### Defers

Specific longitudinal continuity in personality, cognition, relationships, or behavior to their canonical Topics.

## 6. Key Principles

- Continuity does not mean complete sameness.
- Early functioning can relate probabilistically to later functioning.
- New experiences can alter developmental trajectories.
- Development can contain continuity and reorganization simultaneously.


### Topic-specific evidence layer


Evidence focus: assess continuity through preserved organization, function, or strategy while allowing developmental reorganization within the same trajectory.
Developmental continuity concerns persistence and gradual transformation across time. Continuity can refer to persistence of rank order, behavioral organization, skill, expectation, strategy, or underlying tendency. These forms should not be treated as interchangeable. A person can change in average level while remaining relatively stable in rank order, or preserve an organization while changing its expression.

Continuity is also compatible with developmental transformation. Early characteristics can contribute to later outcomes through accumulated experiences and transactions without directly determining them. A stable tendency can influence which environments are entered, and those environments can reinforce, redirect, or compensate for the tendency.

Evidence for continuity depends on the construct and measurement. Stability in one measure does not prove stability of the entire psychological system. Longitudinal evidence is especially useful because it permits direct examination of within-person persistence and change, although measurement error and changing contexts must still be considered.
...
This Topic distinguishes developmental transformations from gradual continuity.

## 2. Definition

Discontinuity is a developmental pattern in which functioning changes through qualitative reorganization, relatively distinct transitions, or forms that cannot be adequately described as simple quantitative increases or decreases.

## 3. Core Understanding

### Mechanism

Discontinuity can occur when new cognitive, emotional, biological, social, or representational organization emerges. A new form of functioning may depend on changes in multiple underlying processes rather than on a simple increase in an existing capacity.

### Types / Forms

A developmental transition may appear discontinuous when a new strategy, representation, role, or level of organization becomes available. The term does not require development to occur in literal stages with sharp boundaries.

### Moderators / Boundary Conditions

Apparent discontinuity can depend on how a construct is measured. A smooth underlying process may appear abrupt if measurement is coarse, while a genuinely qualitative reorganization may be missed by a measure that assumes continuity.

### Evidence Status

Claims of discontinuous development require evidence that the form or organization of functioning changes, not merely that average performance differs between age groups.

### What discontinuity means
Developmental discontinuity refers to qualitative transitions, stage-like changes, reorganizations, or abrupt shifts in the form of functioning. It does not necessarily mean that change happens instantly. A transition can emerge from gradual processes and still produce a qualitatively different organization.

### Stage-like organization
Some developmental theories propose stages in which patterns of thinking or social understanding become organized differently. Stage descriptions can be useful when there is evidence for meaningful qualitative reorganization, but they should not be treated as universally correct merely because development can sometimes appear sequential. Contemporary developmental science often combines continuous and discontinuous accounts.

### Thresholds and reorganization
A system can accumulate gradual changes until a threshold is reached, after which behavior becomes organized differently. Such transitions can arise from changes in capacity, experience, coordination among processes, or environmental demands. The existence of a threshold does not mean that earlier development was irrelevant; earlier changes may have prepared the system for the transition.

### Distinguishing discontinuity from measurement artifacts
An apparent jump can result from changing measurement instruments, task difficulty, sampling differences, or restricted age ranges. Strong claims about discontinuity therefore require designs capable of showing that the underlying construct itself changed in organization rather than merely appearing different under a new task.

### Relationship with continuity
Continuity and discontinuity are not necessarily mutually exclusive. Development can be continuous at one level and discontinuous at another. Gradual accumulation of vocabulary can support a qualitative change in language use; gradual social experience can support new forms of perspective taking. The useful question is therefore: continuous or discontinuous in what aspect, over what timescale, and according to what evidence?

## 4. Relationship to This Chapter

Discontinuity complements continuity and helps characterize the form of developmental change.

## 5. Boundaries

### Owns

The general concept of qualitative or transition-like developmental change.

### Defers

Specific developmental stage theories and domain-specific transitions to their relevant Topics.

## 6. Key Principles

- Discontinuity concerns organization, not simply amount.
- Apparent abrupt change can sometimes reflect measurement.
- Development can combine continuous and discontinuous processes.


### Topic-specific evidence layer


Evidence focus: treat discontinuity as qualitative reorganization or transition, not merely a larger amount of ordinary quantitative change.
Discontinuity refers to developmental reorganization in which a later form is not adequately described as a simple quantitative extension of an earlier form. A change can be discontinuous at one level while being supported by many gradual changes at another. This makes continuity and discontinuity compatible rather than mutually exclusive.

Discontinuity can involve new strategies, representations, roles, relationships, or forms of coordination. A child may reorganize a problem-solving approach rather than simply become faster at the old approach. A social transition can alter the organization of relationships rather than merely increase the number of interactions.
...
This Topic defines stability as persistence across time and distinguishes it from the absence of all change.

## 2. Definition

Developmental stability is the degree to which an individual's relative characteristics, patterns, or functioning remain consistent across time.

## 3. Core Understanding

### Mechanism

Stability can arise from persistent biological characteristics, repeated environments, established relationships, learned patterns, self-maintaining processes, and consistent person–environment transactions.

Stability is usually probabilistic rather than absolute. A person can remain relatively high or low compared with others while still changing substantially in absolute terms.

### Types / Forms

Rank-order stability concerns whether people retain their relative positions within a group. Mean-level stability concerns whether the average level of a characteristic changes across time. Ipsative stability concerns consistency in an individual's internal pattern across characteristics.

These forms answer different questions and should not be treated as interchangeable.

### Moderators / Boundary Conditions

Stability varies by characteristic, developmental period, measurement method, and context. Some patterns become more stable with age, while transitions can temporarily disrupt established patterns.
...
The general developmental concept of stability.

### Defers

Personality stability, cognitive stability, relationship stability, and other domain-specific forms to their canonical owners.

## 6. Key Principles

- Stability does not mean no change.
- Rank-order and mean-level stability answer different questions.
- Stability can vary across development and across constructs.
- Measurement reliability affects estimates of stability.


### Topic-specific evidence layer


Evidence focus: distinguish stability in relative standing or functioning from the absence of developmental change altogether.
Stability describes persistence across time, but the relevant kind of persistence must always be specified. Rank-order stability asks whether people retain their relative positions. Mean-level stability asks whether a population's average remains similar. Structural stability asks whether relationships among components remain organized similarly. These are different questions.

Stability does not imply immutability. A characteristic can show substantial persistence while remaining responsive to experience. Likewise, a population can show a stable average while individuals move in different directions. Developmental interpretation therefore requires both stability and individual trajectories.

Measurement can create apparent stability or apparent change. A reliable measure can still fail to capture changes in the construct's expression, while a noisy measure can make stable functioning look variable. Context also matters because the same underlying characteristic can be expressed differently as demands change.
...
Stability is also scale-dependent. A person can be stable across years while showing substantial moment-to-moment variability, and a group can be stable in its average while containing diverse individual trajectories. The level of analysis must therefore be specified. Stability estimates are always conditional on the population, measure, interval, and context. Stability should therefore never be treated as a timeless property of a person. Stability is therefore a property of a relationship between person, measure, interval, and context.  Stability estimates depend on the construct, population, measure, interval, and context in which stability is assessed. 
...
This Topic provides the broad temporal counterpart to stability and identifies change as a normal feature of development.

## 2. Definition

Change is an alteration in the level, structure, organization, or expression of a characteristic or process across time.

## 3. Core Understanding

### Types / Forms

Change can involve increases, decreases, reversals, qualitative transformations, differentiation, integration, or reorganization. It can be gradual or relatively rapid and can occur within one domain while other domains remain stable.

### Mechanism

Change may result from maturation, learning, experience, social interaction, biological adaptation, environmental transitions, or reciprocal person–environment processes.

### Development

Change does not necessarily mean improvement. A developmental transition can involve gains and losses simultaneously, and some changes can be adaptive in one context but costly in another.

### Moderators / Boundary Conditions

The meaning and direction of change depend on the construct and measurement. Changes in test performance, for example, may reflect true developmental change, practice, changing motivation, or measurement artifacts.
...
The general concept of change across developmental time.

### Defers

Specific developmental changes to their domain-specific Topics.

## 6. Key Principles

- Change is not synonymous with improvement.
- Change can be quantitative or qualitative.
- Gains and losses can occur together.
- Developmental change must be distinguished from simple age-group differences.


### Topic-specific evidence layer


Evidence focus: define change by its direction, magnitude, timing, and measurement rather than assuming every developmental difference is meaningful.
Change is the complementary concept to stability. In developmental science, change can refer to alteration in level, organization, strategy, timing, or function. It should not automatically be interpreted as improvement because development includes both gains and losses.

A useful analysis distinguishes within-person change from between-person difference. A population can show average change while individuals vary widely, and a stable average can conceal simultaneous improvement and decline among different people. Change also has a rate and shape; it may be gradual, accelerated, delayed, nonlinear, or interrupted.
...
This Topic explains a strong form of developmental timing in which a particular window is especially necessary for a developmental process.

## 2. Definition

A critical period is a limited developmental window during which a particular experience or biological condition is required, or is especially necessary, for normal development of a particular function, with markedly reduced potential for equivalent development outside that window.

## 3. Core Understanding

### Mechanism

Critical periods arise when developmental systems have time-sensitive dependencies. During such a period, particular inputs can interact with biological organization to establish or refine a function. If the required conditions are absent, later development may be substantially constrained.

### Boundary Conditions

A critical period is stronger than a sensitive period. Evidence for a critical period requires evidence that the opportunity for typical development is substantially lost or sharply reduced outside the window.

Critical periods are generally specific to particular functions or systems. The existence of a critical period for one developmental process does not mean that all development is similarly time-limited.

### Evidence Status

Some strong critical-period effects are well established in biological and perceptual development. In human psychological development, claims should be made cautiously because many capacities retain some plasticity beyond early windows.
...
The general concept of strongly time-limited developmental opportunity.

### Defers

Specific critical periods in language, sensory systems, neural development, or other domains to their canonical Topics.

## 6. Key Principles

- Critical periods are strongly time-sensitive developmental windows.
- They are more restrictive than sensitive periods.
...
Evidence focus: critical periods require evidence for unusually constrained timing, not merely evidence that earlier experience has stronger effects.
...
This Topic explains developmental windows during which experience has unusually strong effects without implying that equivalent development becomes impossible afterward.

## 2. Definition

A sensitive period is a developmental window during which a particular experience has especially strong or efficient effects on the development of a function, although development remains possible outside that window.

## 3. Core Understanding

### Mechanism

Sensitive periods arise when biological systems and experience are especially responsive to one another during particular developmental phases. Experience during the window can have disproportionately large or efficient effects.

### Boundary Conditions

Sensitive periods differ from critical periods. A sensitive period increases the importance or efficiency of experience during a window; it does not necessarily create an absolute cutoff after which development cannot occur.

Sensitive periods can also vary in timing and duration across functions and individuals.

### Development

Experience outside a sensitive period may still matter, but it can require more effort, different conditions, or compensatory processes.
...
Sensitive periods connect developmental timing with plasticity and help explain why the same experience can have different effects at different ages.

## 5. Boundaries

### Owns

The general concept of time-enhanced developmental sensitivity.

### Defers

Specific sensitive periods in language, perception, attachment, or other domains.

## 6. Key Principles

- Sensitive periods are windows of heightened developmental responsiveness.
...
Evidence focus: sensitive periods permit greater flexibility in timing while still indicating that some developmental windows may be especially influential.
...
This Topic explains the capacity of developmental systems to change in response to experience, context, and changing conditions.

## 2. Definition

Developmental plasticity is the capacity of biological, psychological, or behavioral systems to modify their organization or functioning in response to experience, environmental conditions, or developmental demands.

## 3. Core Understanding

### Mechanism

Plasticity can involve changes in neural organization, skills, strategies, behavior, knowledge, regulation, or adaptation. It may be supported by learning, practice, social experience, biological processes, and environmental change.

Plasticity does not mean unlimited flexibility. Development occurs within biological and experiential constraints, and the ease, direction, and extent of change can vary by developmental period and individual.

### Types / Forms

Plasticity can be adaptive, neutral, or maladaptive depending on the environment and the resulting pattern. A system can become better fitted to a stable environment while becoming less flexible when circumstances change.

### Development

Plasticity is especially relevant during periods when systems are highly responsive to experience, but it persists to varying degrees across the lifespan.

### Moderators / Boundary Conditions

Age, health, prior experience, motivation, social support, environmental stability, and the nature and intensity of experience can influence plasticity.
...
The general developmental concept of capacity for experience-related change.

### Defers

Neural plasticity to Chapter 1.3 and learning mechanisms to Chapter 1.7.

## 6. Key Principles

- Development is constrained but not fixed.
- Plasticity varies across systems, people, and developmental periods.
...
Evidence focus: plasticity concerns modifiability within constraints; evidence should specify what can change, under which conditions, and for whom.
...
This Topic protects developmental interpretation from confusing generational differences with age-related change.

## 2. Definition

A cohort effect is a difference associated with belonging to a particular birth or historical cohort rather than with aging itself.

## 3. Core Understanding

### Mechanism

People born during the same period can share historical conditions such as education, technology, nutrition, economic conditions, social norms, political events, and health environments. These shared experiences can produce differences between cohorts.

### Moderators / Boundary Conditions

Cohort effects are difficult to separate from age and historical period in simple designs. If older adults score differently from younger adults in a cross-sectional study, the difference could reflect aging, cohort differences, or interactions with the historical period.

### Evidence Status

Longitudinal, cross-sectional, and sequential designs provide different information. Sequential designs are especially useful when researchers need to disentangle age, cohort, and period influences.
...
Cohort effects are essential to interpreting lifespan research accurately.

## 5. Boundaries

### Owns

The methodological and developmental concept of cohort-related differences.

### Defers

General research-design methodology to Chapter 1.2 and specific developmental findings to their domain Topics.

## 6. Key Principles

- Cohort effects arise from shared historical experience.
...
Evidence focus: cohort effects require separating birth-generation differences from age and historical-period effects in developmental comparisons.
...
Cohort interpretation is especially important when developmental conclusions span decades. Historical changes in education, technology, health, family life, and social norms can alter the baseline against which age differences are measured. Cohort effects can be especially large when historical conditions alter education, technology, health, or social roles. These effects must remain visible in long-term developmental comparisons. Historical context is part of developmental interpretation whenever cohorts have encountered substantially different conditions.  Cohort interpretation should remain visible whenever historical conditions plausibly differ across age groups. 

---

# 15. Developmental research methods

## 1. Purpose

This Topic identifies the research approaches used to study developmental change while preserving the methodological ownership of Chapter 1.2.

## 2. Definition

Developmental research methods are strategies for studying how biological, psychological, behavioral, and social characteristics change, remain stable, or interact across developmental time.

## 3. Core Understanding

### Types / Forms

Cross-sectional designs compare people of different ages at one point in time. Longitudinal designs follow the same individuals across time. Sequential designs combine elements of both to help separate age, cohort, and period effects.

Researchers can also use experimental, observational, naturalistic, experience-sampling, and genetically informed approaches depending on the question.

### Mechanism

The method must match the developmental claim. If the question concerns within-person change, repeated measurement is generally necessary. If the question concerns causal influence, stronger causal designs are required. If the question concerns naturally occurring developmental variation, observational or longitudinal methods may be appropriate.

### Moderators / Boundary Conditions

Attrition, practice effects, selective participation, measurement non-equivalence, cohort differences, historical changes, and age-related differences in task interpretation can distort developmental conclusions.

Measurement must remain comparable enough across ages for observed differences to support the intended interpretation.
...
The application of research-design principles specifically to developmental questions.

### Defers

General research methodology, statistics, psychometrics, validity, and scientific inference to Chapter 1.2.

## 6. Key Principles

- Research design must match the developmental question.
- Longitudinal evidence is central for studying within-person change.
...
Methodological interpretation also depends on what the design can and cannot identify. Longitudinal evidence is especially useful for observing within-person ordering, but attrition, selective participation, practice effects, and changing measurement conditions can affect the observed trajectory. Cross-sectional evidence is efficient for describing age-group differences, but age is entangled with cohort when groups were born in different historical periods. Sequential designs can provide additional leverage by combining longitudinal and cross-sectional information, although they do not make all age, period, and cohort effects automatically identifiable. Developmental measurement must also remain comparable enough across ages for a score difference to have the intended meaning; changes in task familiarity, language demands, response strategies, or measurement properties can otherwise masquerade as developmental change. The design should therefore be treated as part of the evidence claim rather than as a neutral container for findings. A strong developmental inference states which source of variation is being estimated, which alternatives remain plausible, and what evidence would distinguish them.

Evidence focus: developmental methods must match the question, especially when distinguishing within-person change from between-person age differences.
...
Evidence focus: biological development concerns bodily and biological change as part of development without reducing psychological development to biology alone.
...
Evidence focus: motor development should be interpreted through changing capacities, practice, maturation, and environmental opportunities across time.
...
Evidence focus: perceptual development concerns changing perceptual capacities and organization while remaining distinct from the general perception construct.
...
Perceptual development is inseparable from the opportunities available for exploration and action. The developmental system is therefore not merely receiving sensory input; it is actively generating and selecting information through behavior. Perceptual development is also affected by active exploration. The organism changes the information it receives by moving, attending, selecting objects, and interacting with people. Perceptual development is therefore partly generated through active interaction with the environment.  Perceptual change can alter both available information and the effort required to use that information. 
...
Evidence focus: cognitive development tracks developmental change in cognitive functioning while leaving general cognition to its canonical owner.
...
Evidence focus: language development concerns developmental changes in language capacities, use, and organization without replacing general language science.
...
Evidence focus: emotional development examines how emotional capacities and patterns change across development while preserving the general emotion construct.
...
Evidence focus: social development concerns developmental change in social functioning and relationships without becoming the general owner of social behavior.
...
Evidence focus: personality development addresses developmental continuity and change in personality rather than redefining personality itself.
...
Evidence focus: moral development examines how moral understanding, judgment, and related capacities change across developmental periods.
...
Evidence focus: self development concerns developmental change in self-representation and self-functioning while leaving the general self construct elsewhere.
...
Evidence focus: identity development examines how identity structures and commitments develop, change, and become differentiated across the lifespan.
...
Evidence focus: executive-function development tracks developmental change in executive control while retaining executive function as the broader construct.
...
Executive-function development is affected by both maturation and repeated practice. Tasks that initially require substantial conscious control can become more efficient with experience, changing the apparent demand on executive resources. Conversely, emotional arousal, sleep loss, stress, or complex social conditions can temporarily reduce performance. Developmental competence should therefore be distinguished from performance under one constrained condition. Executive development should be interpreted under realistic demands. Laboratory control and everyday self-regulation can overlap without being identical, so ecological context matters. Executive development is sensitive to task demands and therefore cannot be inferred from one performance condition.  Executive development reflects both changing control capacity and changing task demands. 
...
Evidence focus: emotion-regulation development examines how regulatory capacities emerge and reorganize while remaining distinct from general emotion regulation.
...
Evidence focus: social-cognition development concerns developmental changes in interpreting social information, people, relationships, and social situations.
...
Evidence focus: theory of mind requires attention to developmental changes in understanding others' mental states and the evidence used to infer them.
...
Evidence focus: prenatal development examines developmental processes before birth and their later implications without treating prenatal influence as deterministic.
...
Evidence focus: birth and neonatal development concerns the transition into extrauterine life and early adaptation without collapsing it into infancy.
...
Evidence focus: infancy emphasizes rapid early developmental change while recognizing substantial individual variation and dependence on caregiving context.
...
Evidence focus: early childhood concerns developmental organization after infancy, including emerging capacities and changing social and cognitive contexts.
...
Evidence focus: middle childhood captures developmental changes occurring within increasingly structured learning, peer, family, and social environments.
...
Evidence focus: adolescence should be treated as a heterogeneous developmental period involving interacting biological, cognitive, social, and identity changes.
...
Evidence focus: puberty refers specifically to biological maturation and should not be equated with the entire psychological period of adolescence.
...
Evidence focus: emerging adulthood concerns developmental patterns associated with the transition toward adult roles while recognizing cultural and individual variation.
...
Evidence focus: adulthood is a broad developmental period containing continued change, stability, adaptation, and substantial individual differences.
...
Evidence focus: older adulthood should not be defined solely by decline; developmental functioning can include adaptation, maintenance, and selective change.
...
Older adulthood is heterogeneous because people enter later life with different health histories, education, occupations, relationships, resources, and accumulated skills. Compensation and environmental adaptation can preserve functioning even when some underlying capacities change. Developmental interpretation should therefore focus on functioning and trajectory rather than age alone. Older adulthood should therefore be interpreted through functioning, adaptation, and individual trajectory rather than through chronological age as a single explanatory variable. Older adulthood contains both constraint and adaptation, with substantial variation among individuals.  Older adulthood contains substantial heterogeneity in health, cognition, relationships, resources, and adaptation. 
...
Evidence focus: aging describes developmental processes associated with increasing age while avoiding the assumption that all aging-related change is pathological.
...
Evidence focus: cognitive aging requires distinguishing changes in different cognitive functions because age-related trajectories are not uniform across abilities.
...
Evidence focus: socioemotional aging examines developmental change in emotional and social functioning while accounting for goals, context, and individual differences.
...
Evidence focus: death and dying belong to lifespan development as processes involving developmental, relational, emotional, and contextual dimensions near the end of life.
...
Evidence focus: attachment is treated as a developmental relational system whose patterns emerge through interactions between people and caregiving contexts.
...
Evidence focus: attachment theory belongs to developmental theory and should be evaluated through its assumptions, mechanisms, evidence, and limits.
...
Evidence focus: attachment security concerns the developmental organization of attachment-related expectations and behavior, not a permanent global trait.
...
Security can support exploration because the person has confidence that support is available when needed. This does not imply perfect caregiving or absence of distress. Security is best understood as a relational organization that can vary across relationships and contexts, and developmental conclusions should avoid converting it into a global personality score. Security can support exploration precisely because the relationship provides a reliable base for returning to regulation when demands exceed current coping resources. Security concerns the usefulness and availability of support, especially under stress.  Security concerns reliable access to support and does not imply absence of distress or conflict. 
...
Evidence focus: attachment insecurity concerns patterns of attachment-related organization and should not be treated as a simple pathology label.
...
Evidence focus: attachment development requires attention to timing, caregiving relationships, changing representations, and continuity or revision across development.
...
Evidence focus: temperament development concerns changing patterns of individual reactivity and regulation while distinguishing developmental change from stable differences.
...
Evidence focus: parenting processes are developmental influences and transactions, not one-directional causes that determine children's outcomes.
...
Evidence focus: family influences should be understood through reciprocal relationships, developmental timing, and the broader contexts in which families operate.
...
Evidence focus: peer development concerns changing peer relationships and social functioning across development without replacing the general study of social behavior.
...
Peer development includes friendship, group norms, acceptance, rejection, cooperation, status, and social learning. Peer effects are not inherently negative; peers can support competence and prosocial behavior as well as risk. Selection also matters because people partly choose environments that fit their interests and characteristics. Peer environments can amplify existing tendencies but can also create new developmental opportunities. Peer development is therefore both a context and a mechanism. Peer development can create either protective or risky social pathways depending on group norms and context.  Peer contexts can amplify, redirect, or protect developmental trajectories depending on norms and relationships. 
...
Evidence focus: school and learning context captures developmental effects of structured educational environments while leaving general learning to its canonical chapter.
...
Evidence focus: cultural influences are developmental when they alter opportunities, expectations, meanings, or pathways across time; general culture remains separately owned.
...
Evidence focus: adolescent identity exploration concerns developmental examination and revision of possible identities, commitments, roles, and future directions.
...
Evidence focus: adolescent risk-taking should be interpreted developmentally through timing, context, reward sensitivity, social influence, and changing regulation.
...
Evidence focus: adult cognitive development concerns continued cognitive change and adaptation in adulthood rather than assuming cognition stops developing after adolescence.
...
Evidence focus: socioemotional selectivity links developmental change in goals and social priorities with changing perceptions of time and available resources.
...
Evidence focus: cognitive reserve concerns developmental resources and experiences associated with resilience of cognitive functioning, without implying immunity to decline.
...
Evidence focus: developmental risk concerns conditions that increase the probability of adverse developmental pathways without making outcomes inevitable.
...
Developmental risk should be interpreted probabilistically and temporally. Risks can accumulate, interact, and operate differently at different stages. Correlated exposures make single-factor explanations difficult, and population-level risk should never be converted into deterministic individual prediction. Protective processes and uncertainty belong in the interpretation. Developmental risk is most informative when its timing, severity, duration, and interaction with protective factors are specified. A risk count alone can conceal major differences in developmental exposure. Risk factors alter probability and should always be interpreted with timing and protective conditions.  Developmental risk changes probability and must be interpreted with timing, exposure, and protective conditions. 
...
Evidence focus: developmental resilience concerns adaptive trajectories under adversity and should be evaluated through processes and contexts rather than a fixed trait.
