...
**Status:** LOCKED & SEALED 🔒 — CANONICAL KNOWLEDGE VERSION 2.0ntology:** Locked 118-topic Chapter 1.2 index  
...
### Science
1.2.1 Psychological science
1.2.2 Scientific inquiry
1.2.3 Basic research
1.2.4 Applied research
1.2.5 Scientific theory
...
1.2.12 Falsifiability
1.2.13 Evidence
1.2.14 Evidence quality
1.2.15 Scientific uncertainty
1.2.16 Scientific consensus
1.2.17 Pseudoscience
1.2.18 Replication
1.2.19 Reproducibility
1.2.20 Generalizability

### Research designs
1.2.21 Experimental research
1.2.22 Randomized experiment
1.2.23 Quasi-experiment
1.2.24 Correlational research
1.2.25 Observational research
1.2.26 Naturalistic observation
1.2.27 Survey research
1.2.28 Case study
1.2.29 Longitudinal design
1.2.30 Cross-sectional design
...
Psychological science is the scientific enterprise through which psychological phenomena are systematically described, measured, explained, tested, and accumulated into reliable knowledge. It belongs at the beginning of this chapter because the later topics describe the concepts, methods, evidence standards, measurement practices, and ethical safeguards that make scientific psychological knowledge possible.

## 2. Definition

Psychological science is the systematic scientific study of psychological phenomena and behavior using empirical observation, measurement, research design, theory, inference, and critical evaluation of evidence.

It is not one single method. Different psychological questions require different methods, including experiments, correlational studies, longitudinal research, qualitative inquiry, psychometric measurement, and systematic synthesis. What makes the enterprise scientific is not the use of one particular design but the disciplined use of methods that permit claims to be evaluated against evidence.
...
Psychological science is the umbrella concept for Chapter 1.2. Scientific inquiry describes its reasoning process; research designs describe ways of obtaining evidence; variables and inference describe how observations are interpreted; statistics and sampling describe important quantitative foundations; psychometrics addresses psychological measurement; and open science and ethics address reliability, transparency, responsible conduct, and protection of research participants.

## 5. Boundaries

### Owns

The general concept of psychological science as a scientific knowledge enterprise studying psychological phenomena.
...
Scientific inquiry explains the disciplined process through which psychological questions are converted into testable investigations and evidence is used to refine knowledge. It is the operating logic connecting questions, concepts, observations, measurements, analysis, interpretation, and revision.

## 2. Definition

Scientific inquiry is a systematic process of asking empirically answerable questions, developing testable propositions or observations, collecting and analyzing relevant evidence, evaluating competing explanations, and revising conclusions in light of the evidence.
...
Scientific inquiry provides the logic underlying the research designs, inference concepts, statistics, measurement practices, and open-science safeguards in this chapter. It explains why methodological choices must be matched to the question being asked.

## 5. Boundaries

### Owns

The general process and logic of systematic scientific investigation.
...
Basic research identifies and studies fundamental psychological processes without requiring immediate practical application. It is important because many later applications depend on knowledge whose initial purpose was simply to understand how psychological systems work.

## 2. Definition

Basic research is research primarily intended to develop general knowledge about underlying phenomena, mechanisms, relationships, or principles rather than to solve an immediate practical problem.

Basic research can eventually have major practical consequences even when no direct application was intended at the time it was conducted.
...
Basic research belongs to the Science section because it describes one major purpose of psychological research. It contrasts with applied research while remaining methodologically connected to it.

## 5. Boundaries

### Owns

The concept of research primarily aimed at fundamental understanding rather than immediate practical problem-solving.
...
Applied research addresses questions connected to practical problems, decisions, interventions, environments, or outcomes. It belongs in this chapter because psychological knowledge becomes operationally useful only when evidence can be connected responsibly to real-world conditions.

## 2. Definition

Applied research is research primarily intended to address a practical problem or inform action, policy, intervention, design, assessment, organizational practice, health, education, or another real-world need.
...
Applied research complements basic research in the Science section. The distinction helps prevent two errors: treating fundamental research as irrelevant because it lacks immediate application, and assuming that basic findings automatically justify practical interventions.

## 5. Boundaries

### Owns

The concept of research primarily directed toward practical problems and decisions.
...
Scientific theory explains how organized theoretical knowledge connects observations, concepts, relationships, and mechanisms. It is essential because psychological science does not consist only of isolated findings; theories provide structures for explaining patterns and generating predictions.

## 2. Definition

A scientific theory is a systematic set of concepts and propositions that organizes observations, explains relationships or mechanisms, generates testable predictions, and provides a framework for understanding a domain of phenomena.

A theory is not merely a guess. In science, a theory can be strongly supported while still remaining open to revision.
...
Scientific theory is foundational to scientific inquiry because theories organize questions and generate hypotheses. It connects directly to theory construction, hypothesis, prediction, explanation, falsifiability, and evidence.

## 5. Boundaries

### Owns

The general concept of scientific theory as an organized explanatory framework.
...
Scientific inference is the disciplined movement from observations or data to conclusions about phenomena, relationships, mechanisms, or populations. It matters because data do not interpret themselves; conclusions depend on assumptions, design, measurement, uncertainty, and alternative explanations.
...
The general concept and logic of drawing scientific conclusions from evidence.
...
Falsifiability concerns whether a scientific claim places meaningful constraints on what could count as evidence against it. It helps distinguish empirically testable propositions from claims that can be made compatible with every possible observation.

## 2. Definition

Falsifiability is the property of a claim being formulated so that some logically or empirically possible observation could count against it under specified testing conditions.
...
The concept of empirical testability through possible disconfirming observations.
...
Evidence is the information used to support, challenge, distinguish, or refine scientific claims. It is central to the chapter because psychological knowledge must be grounded in observations and measurements rather than confidence, authority, or intuition alone.

## 2. Definition

Scientific evidence is information obtained through systematic observation, measurement, experimentation, analysis, or synthesis that is relevant to evaluating a scientific claim.
...
The general concept of empirical information used to evaluate scientific claims.
...
Evidence quality determines how much confidence a body of evidence can reasonably support. It prevents the common error of treating all observations, studies, measurements, or published findings as equally informative.
...
Criteria and reasoning for evaluating the quality of scientific evidence.
...
Scientific uncertainty describes what remains unknown, imprecise, variable, contested, or dependent on assumptions. It is necessary for scientifically honest communication because uncertainty exists even when evidence is strong.

## 2. Definition

Scientific uncertainty is the state in which the exact value, relationship, explanation, prediction, or generality of a scientific claim is not known with complete confidence.
...
The general concept of uncertainty in scientific knowledge and its sources and communication.
...
Scientific consensus describes broad agreement among qualified researchers about a scientific proposition when evidence has converged sufficiently to support substantial shared confidence. It helps distinguish accumulated scientific understanding from isolated opinions.

## 2. Definition

Scientific consensus is a broad, evidence-based convergence of expert judgment about a scientific claim, model, or body of findings within a defined field and time period.
...
The concept of evidence-based convergence of expert scientific judgment.
...
Pseudoscience identifies practices or claims that present themselves as scientific while failing to meet important standards of scientific inquiry. Understanding it protects psychological knowledge from claims that use scientific language without adequate empirical accountability.

## 2. Definition

Pseudoscience refers to systems of claims, methods, or practices presented as scientific but characterized by substantial failure to meet relevant standards of empirical testability, evidence, methodological rigor, transparency, or openness to correction.
...
The general concept and identifying features of pseudoscientific claims and practices.
...
Replication examines whether a finding or pattern can be observed again when a study or essential procedure is repeated. It is a major safeguard against treating one result as more stable or general than the evidence warrants.

## 2. Definition

Replication is the deliberate repetition of research to assess whether a previously reported result or phenomenon can be observed again under the same or meaningfully related conditions.
...
The concept of repeating research to assess stability or generality of findings.
...
Reproducibility addresses whether research findings can be obtained again using the same or sufficiently specified data, code, materials, and analytic procedures. It supports transparency and helps determine whether published conclusions can be independently checked.

## 2. Definition

Reproducibility is the ability to obtain the same or appropriately consistent analytical results from the same underlying data, materials, and specified procedures, subject to the definition used in a particular research context.
...
The concept of obtaining research results again from sufficiently specified or shared research materials and procedures.
...
Generalizability concerns how far a scientific finding can reasonably extend beyond the specific people, settings, measures, tasks, and conditions in which it was observed. It protects against turning local evidence into universal psychological laws.

## 2. Definition

Generalizability is the extent to which a finding, relationship, measurement, or conclusion remains applicable across populations, settings, conditions, measures, or other contexts beyond those directly studied.
...
The general concept of extending findings beyond the original study conditions.
...
Experimental research is used when researchers need to test how deliberate changes in conditions affect outcomes. It is especially important for causal questions because experimental control can reduce alternative explanations.
...
The general design of deliberately manipulating conditions to study outcomes.
...
Randomized experiments strengthen causal inference by using random assignment to determine which experimental condition participants receive. This helps balance many pre-existing differences across groups in expectation.

## 2. Definition

A randomized experiment is an experiment in which participants, units, or cases are assigned to conditions using a randomization procedure.
...
Experimental designs using random assignment to conditions.
...
Quasi-experimental designs address causal or intervention questions when researchers can study a meaningful change or comparison but cannot fully randomize assignment.
...
Nonrandomized designs intended to estimate effects of interventions or conditions using quasi-experimental contrasts.
...
Correlational research examines how variables vary together without deliberately manipulating the variables of interest. It is essential for studying relationships that cannot or should not be experimentally manipulated.
...
The general research design based on measuring naturally occurring variable associations.
...
Observational research studies phenomena as they occur without deliberately assigning participants to the key conditions being studied. It is central when manipulation is impossible, unethical, or unnecessary.
...
The general research approach of studying naturally occurring phenomena without experimental assignment.
...
Naturalistic observation studies behavior in settings where it ordinarily occurs. It is valuable for understanding actual behavior without requiring participants to perform an artificial laboratory task.
...
Systematic observation of naturally occurring behavior in natural settings.
...
Survey research provides a systematic way to collect self-reported information, attitudes, experiences, behaviors, characteristics, and beliefs from individuals or groups.
...
The general research design of standardized self-report or interview-based data collection.
...
Case study research provides detailed examination of a bounded individual, group, organization, event, or other case. It is useful when depth, context, complexity, and process are more important than broad population estimation.
...
The general design of intensive investigation of a bounded case.
...
Longitudinal designs study the same individuals, units, or populations across multiple time points. They are essential for understanding change, temporal ordering, stability, and development.
...
The general design of repeated measurement over time.
...
Cross-sectional designs provide a snapshot of variables or groups at a particular time or period. They are efficient for describing prevalence, differences, and associations but have limited information about temporal change.
...
The design of collecting data at one time or short period as a snapshot.
...
## 6. Key Principles
1. Construct requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
6. Boundary conditions can change the meaning or strength of the finding.
7. Population and context determine generalization.
8. Strong use of the concept specifies what it can and cannot establish.
...
## 6. Key Principles
1. Operational definition requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Variable requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Independent variable requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Dependent variable requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Mediator requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Moderator requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Confound requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Control variable requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Causal inference requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Internal validity requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. External validity requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Ecological validity requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Statistical conclusion validity requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Construct validity requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Measurement validity requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Correlation requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Correlation versus causation requires a definition tied to its inferential role.
2. The concept is not identical to a single measurement or statistical output.
3. Interpretation depends on design, measurement, and assumptions.
4. Alternative explanations should remain visible.
5. Causal language requires stronger support than association.
...
## 6. Key Principles
1. Preregistration has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
6. Openness must be balanced with privacy, consent, security, and other legitimate constraints where applicable.
7. Claims about research quality should remain proportional to the safeguards actually used.
8. The concept should be applied precisely rather than as a generic label for “good research.”
...
## 6. Key Principles
1. Registered reports has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Researcher degrees of freedom has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. P-hacking has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. HARKing has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Selective reporting has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Publication bias has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Citation bias has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Meta-analysis has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Systematic review has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Meta-analytic heterogeneity has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Open science has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Data transparency has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Data sharing has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Peer review has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Researcher bias has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Informed consent has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Confidentiality has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Privacy has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Deception has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Debriefing has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Risk–benefit assessment has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Vulnerable populations has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
...
## 6. Key Principles
1. Animal research ethics has a specific scientific or ethical function.
2. Transparency and rigor must be matched to the relevant research context.
3. Methodological safeguards reduce particular risks but do not guarantee perfect evidence.
4. Ethical decisions depend on foreseeable consequences, context, and alternatives.
5. Participant protection and scientific validity are interconnected but distinct.
